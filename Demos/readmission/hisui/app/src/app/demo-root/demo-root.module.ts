...
@NgModule({
  declarations: [ContentContainerComponent, AdmissionRootComponent, WaitingListRootComponent, AdmissionSearchFormComponent, AdmissionSearchTableComponent, UserDischargeModalComponent, UserDischargeFormComponent, WaitingListTableComponent],
  imports: [
    CommonModule,
